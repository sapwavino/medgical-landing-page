export default defineI18nConfig(() => ({
  ...
  messages: {
    pt: {
      ...
      herotext:
        "Registos de consulta instantâneos e em formatos específicos para cada especialidade",
      ...
      contactform: {
        ...
        success_message:
          "Os seus dados foram enviados com sucesso. A nossa equipa irá entrar em contacto consigo brevemente.",
        close: "Fechar",
        contactus: "Contacte-nos",
        hospital_license: "Licença Hospitais e Clínicas",
        try: "Experimente a nossa plataforma",
        try_message:
          "Seja um dos primeiros a experimentar a nossa plataforma gratuitamente e receba um desconto de 50% vitalício.",
        contact_message:
          "Deixe o seu contacto para a nossa equipa de vendas o assitir.",
        name: "Nome",
      ...
      notes: {
        ...
        symptoms_value:
          "Dor torácica opressiva, que agrava com os esforços, com início há 3 meses.",
        exams: "Exames complementares",
        exams_value:
          "Ecocardiograma 2/1/2024: Boa função sistólica biventricular. Sem patologia valvular significativa.",
        restart: "Recomeçar",
        medication: "Medicação habitual",
        medication_value: "Atorvastatina 20mg, 1 comprimido ao Jantar",
        generating_notes: "A gerar notas...",
        transcript:
          "doctor Bom dia Sr. João. O que o traz à consulta? pacient Tenho andado com uma dor no peito e decidi marcar esta consulta. doctor Então e como é essa dor? Quando começou? pacient Começou há 3 meses. É como se fosse um aperto, principalmente quando faço esforços... também trouxe estes exames para ver."
      },
      features: {
        feature1_title: "Notas de consulta automáticas",
        feature1_text:
          "O nosso sistema de IA ouve a entrevista médica e gera os registos clínicos adaptados à sua especialidade, hospital ou clínica",
        ...
        feature2_text:
          "Utilizamos os mais avançados modelos de Inteligência Artificial para gerar notas clínicas e relatórios de qualidade",
        feature3_copy: "Copiar",
        feature3_download: "Descarregar",
        feature3_title: "Fácil de usar",
        feature3_text:
          "Use facilmente com qualquer software clínico ou de gestão hospitalar",
        feature4_title: "Relatórios e notas standardizados",
        feature4_text:
          "Transforma notas desorganizadas ou bullet points em notas e relatórios estruturados e legíveis. Diminui problemas de comunicação entre colegas e erros médicos",
        ...
        feature5_text:
          "Mais de 16 templates de relatórios disponíveis e a crescer todas as semanas. Notas de alta, Cartas de referenciação, Relatórios clínicos, entre outros.",
        feature6_title: "Relatórios criados por voz",
        feature6_text:
          "Facilmente dite a informação para criar o relatório selecionado",
        feature7_title: "Segurança e compliance",
        feature7_text:
          "Encriptação dos dados em trânsito assegura a confidencialidade dos mesmos. GDRP e HIPAA compliant",
        feature8_title: "Privacidade",
        feature8_text:
          "A informação identificável do doente é automaticamente anonimizada através do nosso algoritmo antes do processamento por IA",
        feature8_transcription: "TRANSCRIÇÃO",
        feature8_transcription1: "Obrigado Sr.",
        feature8_transcription2:
          "Pode-me dar o seu número de telemóvel para enviar a receita digital? ",
        feature8_transcription3: "Sim. É o",
        feature9_title: "Dados clínicos não guardados",
        feature9_text:
          "Os dados são processados e eliminados após a geração do relatório"
      },
      feedback: {
        ...
        feedback1:
          "O Médico de Família confronta-se diariamente com um excesso de burocracia que desvia a sua atenção do doente, muitas vez com prejuízo da relação médico-doente. Com a Medgical haverá uma melhoria de eficiência destes processos, devolvendo ao médico tempo e foco, essenciais para a prestação dos melhores cuidados a quem deles precisa.",
        feedback1_name: "Dra. Maria João Nobre",
        feedback1_role:
          "Médica especialista de Medicina Geral e Familiar. Membro do Grupo de Estudos de Saúde Digital da Associação Portuguesa de Medicina Geral e Familliar (APMGF), empreendedora",
        feedback2:
          "As tarefas burocráticas ocupam uma parte muito significativa do tempo dos médicos. Um software como o Medgical irá certamente libertar os médicos de grande parte das tarefas administrativas, redirecionando esse tempo para o que é mais importante: o cuidado ao doente.",
        feedback2_name: "Dr. Vítor Baltazar Martins",
        feedback2_role:
          "Médico  Cardiologista - Especialista em arritmologia e pacing cardíaco",
        feedback2_role2:
          "Director do Serviço de Cardiologia do Hospital de Santarėm.",
        feedback2_role3: "Presidente da Associação Cardiológica do Ribatejo.",
        feedback3:
          "A medgical revolucionou a minha prática clínica. Como pedopsiquiatra, poder estar a a consulta toda a olhar nos olhos do utente, em vez do PC, não tem preço. É incrível e paradoxal como é uma tecnologia que vem humanizar os cuidados.",
        feedback3_name: "Dr. David Moreira",
        feedback3_role:
          "Médico Especialista em Psiquiatria da Infância e Adolescência"
      },
      footer: {
        company: "Empresa",
        about: "Sobre nós",
      ...
      reportanim: {
        ...
        transcription:
          "Bateria com longevidade de 6 anos, limiar auricular 0,75 e limiar ventricular 1, mantém-se estável, onda P 0,7 e onda R 10, impedância auricular de 390 e ventricular de 380 ..."
      },
      pricing: {
        ...
        limited_description:
          "Adira agora e tenha um desconto de 50% vitalício.",
        medical_license: "Licença médica",
        medical_license_description: "O plano base para médicos independentes.",
        medical_license_point1:
          "Notas clínicas de 6 especialidades médicas e hospitalares",
        ...
        hospital_license_point2:
          "Notas clínicas personalizadas à sua prática médica",
        hospital_license_point3: "Relatórios clínicos personalizados",
        hospital_license_point4:
          "Horas de transcrição áudio adaptados à dimensão da sua clínica ou hospital",
        hospital_license_point5:
          "Equipa de suporte dedicada por e-mail e telefone",
      ...
      about: {
        ...
        team_description:
          "A Medgical tem uma equipa multidisciplinar que junta médicos, engenheiros e especialistas em inteligência artificial para revolucionar a prática médica.",
        team_member1: {
      ...
      keyPoints: {
        ordinal: "º",
        first: "Sistema em <strong>Portugal</strong> de notas médicas por IA",
        second: "Especializado em Lingua Portuguesa",
        third: "Especialidades médicas e relatorios médicos",
        fourth: "Consultas médicas realizadas com Medgical"
      },
      closeVideo: "Terminar vídeo",
    ...
    en: {
      ...
      hero2: "on autopilot",
      herotext:
        "Immediate consultation notes, reports and specialty-specific templates.",
      ...
      contactform: {
        ...
        success_message:
          "Your data has been successfully sent. Our team will contact you shortly.",
        close: "Close",
      ...
      features: {
        ...
        feature2_text:
          "We use advanced AI models to generate clinical notes and quality reports",
        feature3_copy: "Copy",
        feature3_download: "Download",
        feature3_title: "Easy to use",
        feature3_text:
          "Use easily with any clinical or hospital management software",
        feature4_title: "Standardized reports",
        feature4_text:
          "Transform unstructured notes or bullet points into structured and readable reports. Reduce communication errors between colleagues and medical errors",
        feature4_point1: "Normal physical exam",
        feature4_point2: "Pa 120/80mmHg",
        feature4_point3: "Fc 70bpm",
        feature4_summary1: "Conscious and orientated.",
        feature4_summary2:
          "Cardiac auscultation: S1 and S2 rhythmic and regular, no murmurs or extra sounds",
        ...
        feature5_text:
          "More than 16 templates available and growing weekly. High quality notes, referral letters, clinical reports, etc.",
        feature6_title: "Voice-generated reports",
        feature6_text:
          "Instantly create the selected report by typing or speaking",
        ...
        feature8_transcription2:
          "Could you please give me your mobile number to send the digital prescription? ",
        feature8_transcription3: "Yes. It is the",
        feature9_title: "Unsaved data",
        feature9_text:
          "Data is processed and deleted after generating the report"
      },
      feedback: {
        ...
        feedback1:
          "The Medical Family Doctor frequently faces daily issues with administrative processes that distract him from his patient, often with loss of time to treat his illness. With Medgical, this issue will be significantly improved, returning medical time and attention to the most important matters: patient care.",
        feedback1_name: "Dr. Maria João Nobre",
        feedback1_role:
          "Specialist in General Medicine and Family Medicine. Member of the Portuguese Association for General and Family Medicine (APMGF), founder",
        feedback2:
          "The administrative burdens of tasks are significant, especially for doctors. An app like Medgical will undoubtedly make the doctors' jobs easier, redirecting their time to what is most important: patient care and treatment.",
        feedback2_name: "Dr. Vítor Baltazar Martins",
        feedback2_role:
          "Cardiologist - Specialist in cardiac arrhythmias and pacing cardiology",
        feedback2_role2:
          "Director of the Cardiology Service at Santarém Hospital",
        feedback2_role3:
          "President of the Portuguese Cardiology Association (APAC)",
        feedback3:
          "Medgical has revolutionized my clinical practice. As a child psychiatrist, being able to look the patient in the eye during the entire consultation, instead of at the PC, is priceless. It is incredible and paradoxical how it is a technology that humanizes care.",
        feedback3_name: "Dr. David Moreira",
      ...
      about: {
        ...
        team_title: "Our team",
        team_description:
          "Medgical has a multidisciplinary team that brings together doctors, engineers, and artificial intelligence experts to revolutionize medical practice.",
        team_member1: {
          role: "Cardiologist",
      ...
      reportanim: {
        ...
        transcription:
          "Battery with a 6-year longevity, atrial threshold 0.75 and ventricular threshold 1, remains stable, P wave 0.7 and R wave 10, atrial impedance of 390 and ventricular of 380 ..."
      },
      pricing: {
        ...
        medical_license_point1:
          "Clinical notes for 6 medical and hospital specialties",
        ...
        hospital_license_point2:
          "Clinical notes customized to your medical practice",
        hospital_license_point3: "Custom clinical reports",
        hospital_license_point4:
          "Audio transcription hours adapted to the size of your clinic or hospital",
      ...
      keyPoints: {
        ordinal: "st",
        first: "Medical Notes system in <strong>Portugal</strong> using AI",
        second: "Specialized in Portugese language",
        third: "Medical specialties and medical reports",
        fourth: "Real consultation sessions with Medgical"
      },
