          ...
          <div class="paralax1 absolute z-20 top-5 left-0">
            ...
            >
              <div class="flex items-center">
                ...
                <span class="opacity-50 text-sm">{{ todayDate }}</span>
              </div>
              <div
                class="mt-3 text-sm w-full flex flex-col gap-1 flex-1 overflow-hidden relative"
              >
                <div>
                  <b>{{ $t("notes.patient") }}:</b> João Silva
                </div>
                <div>
                  <b>{{ $t("notes.age") }}:</b> {{ $t("notes.age_value") }}
                </div>
                <div>
                  <b>{{ $t("notes.motive") }}:</b>
                  {{ $t("notes.motive_value") }}
                </div>
                <div>
                  <b>{{ $t("notes.previousdiagnosis") }}:</b>
                  {{ $t("notes.previousdiagnosis_value") }}
                </div>
                <div>
                  <b>{{ $t("notes.medication") }}:</b>
                  {{ $t("notes.medication_value") }}
                </div>
                <div>
                  <b>{{ $t("notes.symptoms") }}:</b>
                  {{ $t("notes.symptoms_value") }}
                </div>
                <div>
                  <b>{{ $t("notes.exams") }}:</b> {{ $t("notes.exams_value") }}
                </div>
              ...
              <button
                @click="reset()"
                class="mt-5 text-sm bg-zinc-300 flex gap-2 items-center cursor-pointer transition-all hover:translate-y-1 hover:shadow-sm rounded-full text-zinc-700 ring-1 ring-zinc-400/50 font-semibold shadow-md shadow-black/10 ring-inset py-3 pl-3 pr-6 mx-auto ubuntu-bold"
              >
                <svg
                  class="h-6 w-6"
    ...
    <div id="features" class="section-features relative">
      <div class="container px-5">
        ...
        >
                ...
                <div class="scroll-element-vertical primary-vertical">
                  <div class="flex flex-col gap-5">
                    <div class="consultation-type">
                      {{ $t("features.feature1_hospitalconsultation") }}
                    </div>
                    <div class="consultation-type">
                      {{ $t("features.feature1_mgf") }}
                    </div>
                    <div class="consultation-type">
                      {{ $t("features.feature1_icpc") }}
                    </div>
                    <div class="consultation-type">
                      {{ $t("features.feature1_pacing") }}
                    </div>
                  </div>
                </div>
                <div class="scroll-element-vertical secondary-vertical">
                  <div class="flex flex-col gap-5">
                    <div class="consultation-type">
                      {{ $t("features.feature1_hospitalconsultation") }}
                    </div>
          ...
          <div class="card">
            <div class="relative h-44 mb-5 flex items-center justify-center">
              <div
          ...
          <div class="card sm:col-span-2">
            ...
            >
              ...
              <div
                class="text-reveal absolute border-r-4 border-zinc-800 top-0 left-0 bottom-0 min-w-10 overflow-hidden magic-report-transform"
          ...
          <div class="card flex flex-col">
            <div class="card-title sm:max-w-44">
              {{ $t("features.feature6_title") }}
            </div>
    ...
    <div class="section-feedback">
      <div class="my-32">
        <div class="mx-auto w-full max-w-2xl flex flex-col mb-10">
          <h2
            class="font-book font-styling font-display mb-2 text-center text-[2rem] md:text-[3rem] tracking-tight leading-[120%] dark:font-gradient text-medgicalBlue"
            style="
          ...
          <div
            class="font-sans mb-24 mt-5 display-paragraph text-center font-medium mx-auto text-medgicalBlue"
          >
