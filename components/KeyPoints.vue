<template>
  <div
    class="container w-2/3 mx-auto mb-24  shadow-md rounded-3xl px-5 py-10 text-center flex flex-col ubuntu-regular"
  >
    <section class="h-36 w-full grid md:grid-cols-4 grid-cols-2 gap-y-10 gap-x-1 text-white ">
      <div class="">
        <svg
        ...
        <p class="mx-5 text-sm text-medgicalBlue " v-html="$t('keyPoints.first')"></p>
      </div>
      <div class="text-medgicalBlue ">
        <h2
