<template>
  ...
  >
    <div class="flex flex-col items-start gap-5 min-w-60">
      <img class="h-6 mt-0.5" src="~/assets/logo.svg" alt="Medgical" />
      <p class="text-base font-medium  opacity-50 mb-2">
        You save lives, we note it!
      </p>
      <JoinButton small />

      <div class="flex flex-col gap-2 text-xs  mt-5">
        {{ $t("footer.sponsored") }}
        <img class="h-9 mt-0.5" src="~/assets/BI-Dark-Green.svg" alt="Boehringer" />
      </div>
    </div>
    <div class="flex flex-col items-start gap-5">
      ...
      <nuxt-link to="https://www.linkedin.com/company/medgical/jobs/">
        {{ $t("footer.careers") }}
      </nuxt-link>
    ...
    <div class="flex flex-row md:flex-col items-end gap-5">
      <div class="rounded-md overflow-hidden flex  items-center shadow-md">
  ...
  <div class="max-w-6xl mx-auto mt-32 mb-4 flex gap-3 px-8">
    ...
    <a href="https://www.instagram.com/medgicalai" target="_blank">
      <svg
        class="fill-current h-7 w-7 opacity-50 hover:opacity-90"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
    ...
    <a href="https://www.linkedin.com/company/medgical" target="_blank">
      <svg
        class="fill-current h-7 w-7 opacity-50 hover:opacity-90"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
